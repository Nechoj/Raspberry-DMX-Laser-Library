...
<html>
  ...
  <body>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      <p>
        <input type="text" class="Inputfield2" name="name" value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name']) : ''; ?>"> name (set, get, create, delete)
      </p>
      <p>
        <input type="text" class="Inputfield2" name="value" value="<?php echo isset($_POST['value']) ? htmlspecialchars($_POST['value']) : ''; ?>"> value (set, create)
      </p>
      <p>
        ...
        </select> datatype (create)
      </p>
      <p>
        <input type="submit" name="button2" class="Button" value="get"> <input type="submit" name="button1" class="Button" value="set"> <input type="submit" name="button3" class="Button" value="create"> <input type="submit" name="button4" class="Button" value="delete">
      </p>
      <p>
        <input type="submit" name="button5" class="Button" value="shutdown server"> <input type="submit" name="button6" class="Button" value="stop laser">
      </p>
    </form><?php
    ...
    if (isset($_REQUEST["button6"])){ // if button6 was clicked on: stop laser
